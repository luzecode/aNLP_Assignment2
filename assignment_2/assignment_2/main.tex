...
\subsection{Batch and Mini-Batch Gradient Descent Loss}
...
\subsubsection{Observation: Batch GD}

The loss decreases from more than 10 to 0.98. 
During the first epochs, the loss drops drastically, followed by a smooth convergence.
...
\textbf{Last commit hash:} \texttt{3f9c7d1a}
