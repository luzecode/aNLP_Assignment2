...
def main():
    ...
    if args.custom_train:
        ...
        hyperparam_list = [
        # base
        {'hidden_size': 128, 'n_layers': 2, 'lr': 0.005, 'n_epochs': 1000, 'print_every': 500},
        # different hidden_size
        {'hidden_size': 64, 'n_layers': 2, 'lr': 0.005, 'n_epochs': 1000, 'print_every': 500},
        {'hidden_size': 256, 'n_layers': 2, 'lr': 0.005, 'n_epochs': 1000, 'print_every': 500},
        # different n_layers
        {'hidden_size': 128, 'n_layers': 1, 'lr': 0.005, 'n_epochs': 1000, 'print_every': 500},
        {'hidden_size': 128, 'n_layers': 3, 'lr': 0.005, 'n_epochs': 1000, 'print_every': 500},
        # different learning rate
        {'hidden_size': 128, 'n_layers': 2, 'lr': 0.001, 'n_epochs': 1000, 'print_every': 500},
        {'hidden_size': 128, 'n_layers': 2, 'lr': 0.01, 'n_epochs': 1000, 'print_every': 500},
    ]
        ########################################################################
